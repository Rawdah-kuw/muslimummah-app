...
class Dhikr {
  ...
  final String prefixEn; // English of the basmala / isti'adha
  ...
  Dhikr(this.ar, this.prefix, this.prefixEn, this.en, this.count, this.source,
      this.sourceEn, this.note, this.noteEn);
